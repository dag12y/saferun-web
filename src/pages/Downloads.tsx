...
const platforms = [
  {
    ...
    install: `curl -fsSL https://saferun.dev/install.sh | sh`,
...
install -m 0755 saferun-darwin-arm64 ~/.local/bin/saferun`,
  },
  {
    ...
    install: `Invoke-Expression (Invoke-WebRequest -Uri https://saferun.dev/install.ps1 -UseBasicParsing).Content`,
