    ...
    <div className="max-w-4xl mx-auto px-5 py-16">
      <div className="mb-12">
        ...
        <p className="text-sm" style={{ color: "var(--fg2)" }}>
          Pre-built binaries for Linux, macOS, and Windows. All releases are
          available on GitHub.
        </p>
      </div>
      ...
      >
        <div>
          ...
          {error && (
            <p className="text-sm" style={{ color: "var(--fg3)" }}>
              Could not load release info. Check GitHub.
            </p>
          )}
          {release && (
        ...
        {platforms.map((platform) => (
          ...
          >
            ...
            <div className="p-6" style={{ background: "var(--card)" }}>
              {/* quick install */}
              <p className="text-xs mono mb-2" style={{ color: "var(--fg3)" }}>
                QUICK INSTALL
              </p>
              <div className="mb-6">
              ...
              {/* binaries */}
              <p className="text-xs mono mb-3" style={{ color: "var(--fg3)" }}>
                DOWNLOAD BINARY
              </p>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  >
                    <path
                      d="M7 1l1.5 4.5H13l-3.75 2.75 1.5 4.5L7 10 3.25 12.75l1.5-4.5L1 5.5h4.5L7 1z"
                      stroke="currentColor"
                      strokeWidth="1.2"
                      fill="none"
                    />
              ...
              <details className="mt-5">
                <summary
                  className="text-xs mono cursor-pointer select-none"
                  style={{ color: "var(--fg3)" }}
                >
                  Manual installation
                </summary>
